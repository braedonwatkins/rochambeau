...
function colorChange(choice) {
    ...
    if(choice === 'grass') {return '<span class = "grass-text">grass</span>';}
    else if(choice === 'water') {return '<span class = "water-text">water</span>';}
    else if(choice === 'fire') {return '<span class = "fire-text">fire</span>';}
